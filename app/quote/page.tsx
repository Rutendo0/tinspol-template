      ...
      <section className="pt-32 pb-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Get Your Free Quote</h1>
            ...
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Quick & Easy Process</h2>
